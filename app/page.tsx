...
animate={{ offsetDistance: "100%", opacity: [0, 1, 1, 0] }}
        ...
        {/* HOW TO TRADE – PREMIUM SVG ICONS */}
        <section id="how" className="py-20 px-5">
          ...
          {/* Trust Badges – Premium SVG Icons */}
          <div className="flex flex-wrap justify-center gap-10 md:gap-16 max-w-2xl mx-auto">
            {/* FAST */}
        ...
        {/* RECENT TRADES – FULLY DEPLOY-SAFE (keeps your exact design) */}
          ...
          <div className="max-w-lg mx-auto">
            ...
            >
              ...
              <div className="relative px-4 py-8 h-56 bg-gradient-to-b from-transparent to-black/20">
                {/* Static candles (pre-calculated, no Math.random) */}
